...
class WorkListCTRLController extends Controller
{
    ...
    public function ReopenparaAction(){
        ...
        foreach ($arr as &$value) {
            ...
            $sql = "UPDATE t_parametrosamostra_log SET  date = NOW() ,  user = '". $this->get('security.token_storage')->getToken()->getUser() ."' , ft_id_estado = (SELECT fn_id FROM t_estados WHERE ft_codigo = 'D' LIMIT 1) where id_table > " . $last[0]["MAX(id_table)"] ;
            $activeDate = $this->getDoctrine()->getManager()->getConnection()->prepare($sql);
            $activeDate->execute();
        }
    ...
    public function CancelparaAction(){
        ...
        foreach ($arr as &$value) {
            ...
            $sql = "UPDATE t_parametrosamostra_log SET  date = NOW() ,  user = '". $this->get('security.token_storage')->getToken()->getUser() ."' , ft_id_estado = (SELECT fn_id FROM t_estados WHERE ft_codigo = 'X' LIMIT 1) where id_table > " . $last[0]["MAX(id_table)"] ;
            $activeDate = $this->getDoctrine()->getManager()->getConnection()->prepare($sql);
            $activeDate->execute();
        }
        return new Response("ok");
...
// set image scale factor
    ...
    public function  GetparameterbysampleAction(){
        ...
        $sql = "select t_parametrosamostra.fn_id_amostra , t_parametrosamostra.ft_descricao , t_parametrosamostra.ft_id_estado , t_metodos.ft_descricao as metodo, t_tecnicas.ft_descricao as tecnica from t_parametrosamostra inner join t_amostras on t_amostras.fn_id = t_parametrosamostra.fn_id_amostra left join t_metodos  on t_parametrosamostra.fn_id_metodo = t_metodos.fn_id left join t_tecnicas on t_metodos.fn_id_tecnica = t_tecnicas.fn_id where (t_amostras.ft_id_estado = (SELECT fn_id FROM t_estados WHERE ft_codigo = 'V' LIMIT 1) or t_amostras.ft_id_estado = (SELECT fn_id FROM t_estados WHERE ft_codigo = 'D' LIMIT 1) or t_amostras.ft_id_estado = (SELECT fn_id FROM t_estados WHERE ft_codigo = 'C' LIMIT 1) or t_amostras.ft_id_estado = (SELECT fn_id FROM t_estados WHERE ft_codigo = 'A' LIMIT 1)) and t_parametrosamostra.fn_id = ". $id_parameter ;
   ...
   // get parameters by sample for worklist groped by parameter
    public function  GetparameterbysampleForParameterAction(){
        ...
        $sql = "select t_parametrosamostra.fn_id_amostra , t_parametrosamostra.ft_descricao , t_parametrosamostra.ft_id_estado , t_metodos.ft_descricao as metodo, t_tecnicas.ft_descricao as tecnica from t_parametrosamostra inner join t_amostras on t_amostras.fn_id = t_parametrosamostra.fn_id_amostra left join t_metodos  on t_parametrosamostra.fn_id_metodo = t_metodos.fn_id left join t_tecnicas on t_metodos.fn_id_tecnica = t_tecnicas.fn_id where (t_amostras.ft_id_estado = (SELECT fn_id FROM t_estados WHERE ft_codigo = 'D' LIMIT 1) or t_amostras.ft_id_estado = (SELECT fn_id FROM t_estados WHERE ft_codigo = 'V' LIMIT 1)) and t_parametrosamostra.fn_id = ". $id_parameter ;
    ...
    public function AddNewparaAction($idsample,$idpara)
    {
        ...
        //log parametros
        $sql = "INSERT INTO t_parametrosamostra_log (fn_id, listatrabalho_id, ft_descricao, fn_id_metodo, fn_id_tecnica, fn_id_amostra, fn_id_areaensaio, fd_limiterealizacao, ft_cumpreespecificacao, ft_conclusao, fn_id_modeloparametro, ft_observacao, fd_criacao, fd_conclusao, fd_autorizacao, fn_id_laboratorio, fn_precocompra, fn_precovenda, fn_factorcorreccao, fb_acreditado, fn_limitelegal, fn_id_familiaparametro, ft_formulaquimica, fn_id_frasco, fn_volumeminimo, fb_confirmacao, ft_id_estado, fb_contraanalise, fd_Realizacao,id) SELECT aa.fn_id, aa.listatrabalho_id, aa.ft_descricao, aa.fn_id_metodo, aa.fn_id_tecnica, aa.fn_id_amostra, aa.fn_id_areaensaio, aa.fd_limiterealizacao, aa.ft_cumpreespecificacao, aa.ft_conclusao, aa.fn_id_modeloparametro, aa.ft_observacao, aa.fd_criacao, aa.fd_conclusao, aa.fd_autorizacao, aa.fn_id_laboratorio, aa.fn_precocompra, aa.fn_precovenda, aa.fn_factorcorreccao, aa.fb_acreditado, aa.fn_limitelegal, aa.fn_id_familiaparametro, aa.ft_formulaquimica, aa.fn_id_frasco, aa.fn_volumeminimo, aa.fb_confirmacao, (SELECT fn_id FROM t_estados WHERE ft_codigo = 'P' LIMIT 1) , aa.fb_contraanalise, aa.fd_Realizacao , aa.id FROM t_parametrosamostra AS aa WHERE aa.id = " . $celso;
        $activeDate = $this->getDoctrine()->getManager()->getConnection();
        $activeDate->prepare($sql)->execute();
        ...
        //log parametros
        $sql = "UPDATE t_parametrosamostra_log SET  ft_id_estado = (SELECT fn_id FROM t_estados WHERE ft_codigo = 'D' LIMIT 1) , date = NOW() ,  user = '". $this->get('security.token_storage')->getToken()->getUser() ."' , fn_id_amostra = " . $idsample . " where id=" . $celso;
    ...
    public function GenerateworklistAction($slug)
    {
        ...
        foreach ($samples as &$slug) {
            ...
            if($amostra->getFtEstado()->getFtCodigo() != 'D'){
                ...
                $sql = "INSERT INTO t_parametrosamostra_log (fn_id, listatrabalho_id, ft_descricao, fn_id_metodo, fn_id_tecnica, fn_id_amostra, fn_id_areaensaio, fd_limiterealizacao, ft_cumpreespecificacao, ft_conclusao, fn_id_modeloparametro, ft_observacao, fd_criacao, fd_conclusao, fd_autorizacao, fn_id_laboratorio, fn_precocompra, fn_precovenda, fn_factorcorreccao, fb_acreditado, fn_limitelegal, fn_id_familiaparametro, ft_formulaquimica, fn_id_frasco, fn_volumeminimo, fb_confirmacao, ft_id_estado, fb_contraanalise, fd_Realizacao,id) SELECT aa.fn_id, aa.listatrabalho_id, aa.ft_descricao, aa.fn_id_metodo, aa.fn_id_tecnica, aa.fn_id_amostra, aa.fn_id_areaensaio, aa.fd_limiterealizacao, aa.ft_cumpreespecificacao, aa.ft_conclusao, aa.fn_id_modeloparametro, aa.ft_observacao, aa.fd_criacao, aa.fd_conclusao, aa.fd_autorizacao, aa.fn_id_laboratorio, aa.fn_precocompra, aa.fn_precovenda, aa.fn_factorcorreccao, aa.fb_acreditado, aa.fn_limitelegal, aa.fn_id_familiaparametro, aa.ft_formulaquimica, aa.fn_id_frasco, aa.fn_volumeminimo, aa.fb_confirmacao, aa.ft_id_estado, aa.fb_contraanalise, aa.fd_Realizacao , aa.id FROM t_parametrosamostra_log AS aa WHERE aa.ft_id_estado = (SELECT fn_id FROM t_estados WHERE ft_codigo = 'V' LIMIT 1) and aa.fn_id_amostra =" . $slug;

                $activeDate = $this->getDoctrine()->getManager()->getConnection()->prepare($sql);
                $activeDate->execute();

                $sql = "UPDATE t_parametrosamostra_log SET  date = NOW() ,  user = '". $this->get('security.token_storage')->getToken()->getUser() ."' , ft_id_estado = (SELECT fn_id FROM t_estados WHERE ft_codigo = 'D' LIMIT 1) , fn_id_amostra = " .$slug . " where id_table > " . $last[0]["MAX(id_table)"] ;
                $activeDate = $this->getDoctrine()->getManager()->getConnection()->prepare($sql);
                $activeDate->execute();
